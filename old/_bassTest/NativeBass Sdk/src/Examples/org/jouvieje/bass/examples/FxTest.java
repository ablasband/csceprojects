...
import static org.jouvieje.bass.defines.BASS_SAMPLE.BASS_SAMPLE_FX;
...
import static org.jouvieje.bass.enumerations.BASS_FX_DX8.BASS_FX_DX8_PARAMEQ;
...
import org.jouvieje.bass.structures.BASS_DX8_PARAMEQ;
import org.jouvieje.bass.structures.BASS_DX8_REVERB;
 ...
 */
public class FxTest extends JPanel implements BassExample
{
	...
	private void updateFX(int index, int value)
	{
		if(index < 3)
		{
			BASS_DX8_PARAMEQ p = BASS_DX8_PARAMEQ.create();
		...
		{
			BASS_DX8_REVERB p = BASS_DX8_REVERB.create();
