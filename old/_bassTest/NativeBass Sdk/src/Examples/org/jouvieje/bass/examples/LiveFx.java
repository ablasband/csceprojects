...
import static org.jouvieje.bass.defines.BASS_DATA.BASS_DATA_AVAILABLE;
import static org.jouvieje.bass.defines.BASS_DEVICE.BASS_DEVICE_LATENCY;
...
import static org.jouvieje.bass.enumerations.BASS_FX_DX8.BASS_FX_DX8_CHORUS;
import static org.jouvieje.bass.enumerations.BASS_FX_DX8.BASS_FX_DX8_FLANGER;
import static org.jouvieje.bass.enumerations.BASS_FX_DX8.BASS_FX_DX8_GARGLE;
import static org.jouvieje.bass.enumerations.BASS_FX_DX8.BASS_FX_DX8_REVERB;
...
import org.jouvieje.bass.enumerations.STREAMPROC_SPECIAL;
...
import org.jouvieje.bass.structures.BASS_INFO;
import org.jouvieje.bass.structures.HFX;
 ...
 */
public class LiveFx extends JPanel implements BassExample
{
	...
	private int chunk;				//recording chunk size
	...
	public void run()
	{
		...
		BASS_INFO info = BASS_INFO.create();
		BASS_GetInfo(info);
		if(info.getDxVersion() < 8)
		{
