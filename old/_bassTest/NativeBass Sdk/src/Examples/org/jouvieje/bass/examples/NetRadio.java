...
import static org.jouvieje.bass.defines.BASS_CONFIG.BASS_CONFIG_NET_PLAYLIST;
import static org.jouvieje.bass.defines.BASS_CONFIG.BASS_CONFIG_NET_PREBUF;
import static org.jouvieje.bass.defines.BASS_CONFIG_NET.BASS_CONFIG_NET_PROXY;
import static org.jouvieje.bass.defines.BASS_FILEPOS.BASS_FILEPOS_BUFFER;
import static org.jouvieje.bass.defines.BASS_FILEPOS.BASS_FILEPOS_CONNECTED;
import static org.jouvieje.bass.defines.BASS_FILEPOS.BASS_FILEPOS_END;
import static org.jouvieje.bass.defines.BASS_STREAM.BASS_STREAM_AUTOFREE;
import static org.jouvieje.bass.defines.BASS_STREAM.BASS_STREAM_BLOCK;
import static org.jouvieje.bass.defines.BASS_STREAM.BASS_STREAM_STATUS;
import static org.jouvieje.bass.defines.BASS_SYNC.BASS_SYNC_END;
import static org.jouvieje.bass.defines.BASS_SYNC.BASS_SYNC_META;
import static org.jouvieje.bass.defines.BASS_SYNC.BASS_SYNC_OGG_CHANGE;
import static org.jouvieje.bass.defines.BASS_TAG.BASS_TAG_HTTP;
import static org.jouvieje.bass.defines.BASS_TAG.BASS_TAG_ICY;
import static org.jouvieje.bass.defines.BASS_TAG.BASS_TAG_META;
import static org.jouvieje.bass.defines.BASS_TAG.BASS_TAG_OGG;
...
import org.jouvieje.bass.callbacks.DOWNLOADPROC;
import org.jouvieje.bass.callbacks.SYNCPROC;
...
import org.jouvieje.bass.misc.PointerUtils;
import org.jouvieje.bass.structures.HSTREAM;
import org.jouvieje.bass.structures.HSYNC;
 ...
 */
public class NetRadio extends JPanel implements BassExample
{
	...
	private void DoMeta()
	{
		...
		if(metaBuff != null)
		{
			String meta = PointerUtils.toString(metaBuff);
		...
		else
		{
			...
			if(metaBuff != null)
			{
				...
				int length;
				while((length = PointerUtils.stringLength(metaBuff)) > 0) {
					String s = PointerUtils.toString(metaBuff);
					...
					metaBuff = PointerUtils.createSubView(metaBuff, length+1);
				}
			...
			directConnectionCB.addItemListener(new ItemListener(){
				...
				public void itemStateChanged(ItemEvent e)
				{
					...
					if(directConnectionCB.isSelected()) {
						...
						BASS_SetConfigPtr(BASS_CONFIG_NET_PROXY, BufferUtils.createView(proxyPtr));	// enable proxy		//FIXME
					}
				}
			});
		}
