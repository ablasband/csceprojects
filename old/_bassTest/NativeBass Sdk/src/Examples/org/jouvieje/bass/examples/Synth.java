...
import static org.jouvieje.bass.defines.BASS_CONFIG.BASS_CONFIG_BUFFER;
...
import org.jouvieje.bass.callbacks.STREAMPROC;
		...
		{
			{
				...
				{
					int r = Integer.parseInt(""+key);		//TODO Simplify the line
					if(fx[r] != null)
					{
