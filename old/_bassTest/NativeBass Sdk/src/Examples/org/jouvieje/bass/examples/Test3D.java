...
import static org.jouvieje.bass.defines.BASS_SAMPLE.BASS_SAMPLE_3D;
import static org.jouvieje.bass.defines.BASS_SAMPLE.BASS_SAMPLE_LOOP;
import static org.jouvieje.bass.defines.BASS_SAMPLE.BASS_SAMPLE_MONO;
...
import org.jouvieje.bass.structures.BASS_3DVECTOR;
 ...
 */
public class Test3D extends JPanel implements BassExample
{
...
//		if(BASS_GetDeviceDescription(2) != null)
	...
	{
		if(currentChannel != -1) return (Channel)channelListModel.getElementAt(currentChannel);
		return null;
	}
	...
	private JComboBox getEnvironments()
	{
		if(environments == null)
		{
			...
			for(; i.hasNext();) model.addElement(i.next());
	...
	private JButton getPlayB()
	{
		if(playB == null)
		{
			...
			playB.addActionListener(new java.awt.event.ActionListener(){
				...
				{
					Channel c = getCurrentChannel();
					if(c != null) BASS_ChannelPlay(c.channel, false);
				}
			});
		}
		return playB;
	...
	private JButton getStopB()
	{
		if(stopB == null)
		{
			...
			stopB.addActionListener(new java.awt.event.ActionListener(){
				...
				{
					Channel c = getCurrentChannel();
					if(c != null) BASS_ChannelPause(c.channel);
				}
			});
		}
		return stopB;
